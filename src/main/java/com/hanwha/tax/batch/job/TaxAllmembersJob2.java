...
@Slf4j
public class TaxAllmembersJob2 extends BaseJob {
    ...
    protected void doExecute(JobExecutionContext context) throws JobExecutionException {
        ...
        if ("true".equals(isMaster)) {
            ...
            custService.getCustListByStatus(Cust.CustStatus.정상.getCode()).forEach(c -> {
                ...
                if (!ynIncome.get()) {
                    taxService.saveTax2(c.getCustId(), Integer.parseInt(Utils.getCurrentDate("yyyy")), null);
                }
            });
        } else {
            // 기준일 ( 당일 )
    ...
    private void procTax(String custId, String yearStr) {
        ...
        taxService.saveTax2(custId, year, calcTax);
    }
}