...
@Setter
@ToString
public class BankTransBT01 extends AbstractMydataCoocon {
	...
	public void parseData(String data) {
		...
		// data 부 검증
		if (dataArr == null || dataArr.length != 17 || !AbstractMydataCoocon.ROW_TYPE.은행수신계좌매핑거래내역.getCode().equals(dataArr[1])) {
	...
	public String getData() {
		...
		sb.append(ROW_TYPE.은행수신계좌매핑거래내역.getCode());sb.append('|');
		...
		sb.append(소득구분);sb.append('|');
		sb.append(삼점삼프로포함여부);sb.append('|');
